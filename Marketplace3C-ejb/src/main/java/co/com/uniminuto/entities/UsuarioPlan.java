...
@NamedQueries({
    ...
    @NamedQuery(name = "UsuarioPlan.findByUsuarioPlan", query = "SELECT up FROM UsuarioPlan up INNER JOIN up.idPlan AS p INNER JOIN up.idUsuario AS u WHERE u.idUsuario = :idUsuario "),
