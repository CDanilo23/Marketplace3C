                ...
                <form action="datosModificarHotel.jsp" method="get"> 
                    <table class='table table-hover'>
                        ...
                        <%
                            ...
                            HotelFacadeLocal hotelFacadeLocal = (HotelFacadeLocal) ctx.lookup("java:app/Marketplace2C-ejb-1.0-SNAPSHOT/HotelFacade!co.com.uniminuto.ejb.HotelFacadeLocal");
                            
                            for (Hotel hotel : hotelFacadeLocal.findAllHoteles()) {
                                out.println("<tr>");
