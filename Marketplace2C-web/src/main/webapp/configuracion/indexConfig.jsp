                        ...
                        <div class="sidebar-nav navbar-collapse">
                            <ul class="nav" id="side-menu">
                                ...
                                <li>
                                    ...
                                    <ul class="nav nav-second-level">
                                        <li>
                                            <a href="../configuracion/ConfiguracionParques.jsp">Consulta Parques</a>
                                        </li>
                                        <li>
                                            <a href="../configuracion/CrearParque.jsp">Crear nuevo Parque</a>
                                        </li>
                                        <li>
                                            <a href="../configuracion/EliminarParque.jsp">Eliminar Parque</a>
                                        </li>
                                    </ul>
                                    <!-- /.nav-second-level -->
                                </li>
                                <li>
                                    ...
                                    <ul class="nav nav-second-level">
                                        <li>
                                            <a href="configuracionHoteles/ConfiguracionHoteles.jsp">Consulta hoteles</a>
                                        </li>
                                        <li>
                                            <a href="configuracionHoteles/CrearHotel.jsp">Crear nuevo hotel</a>
                                        </li>
                                        <li>
                                            <a href="configuracionHoteles/EliminarHotel.jsp">Eliminar hotel</a>
                                        </li>
                                    </ul>
                                    <!-- /.nav-second-level -->
                                </li>
                                <li>
                                    ...
                                    <ul class="nav nav-second-level">
                                        <li>
                                            <a href="../configuracion/ConfiguracionProveedores.jsp">Consulta proveedores</a>
                                        </li>
                                        <li>
                                            <a href="../configuracion/CrearProveedor.jsp">Crear nuevo proveedor</a>
                                        </li>
                                        <li>
                                            <a href="../configuracion/EliminarProveedor.jsp">Eliminar proveedor</a>
                                        </li>
                                    </ul>
                                    <!-- /.nav-second-level -->
                                </li>
